...
# notice
```
纵观国内开源界，大部分开源项目都是半途而废，
其实有很多开源的作者在早期都带着一个美好的想法去开源，希望能把开源项目做好做大，他们的项目也有着较好的潜力。

但是做着做着，会发现遇到很多的问题。这些问题中，主要的问题并非技术问题本身。
而往往是那些其他的问题，
比如占用作者的时间太多，却没有得到任何正面反馈。
比如一些发现了这个项目的技术人士和非技术人士，都喜欢白嫖，而不提供任何贡献。哪怕是测试反馈bug都不愿意。

这些问题深深的困扰了中国的愿意长期免费开源的技术从业者。同样也困扰了我。

everwar项目开源是从2016年底开始的。到现在有七年多，魔兽世界这个风靡全球的游戏确实做的很成功，经久不衰。
多年来，everwar项目一直和其他国内开源作者一样，单干着。若不是足够的实力和毅力，显然无法支撑到现在。

然而比起其他开源项目，everwar遇到了更复杂的一些问题。everwar项目是一个著名游戏的引擎开源项目。
一些白嫖人士，拿着这个项目的源码和发布版本做开设以盈利为目的的私服，
或者包装成可运行版本在各大电商平台售卖单机版。

这还不够，这些架设盈利私服的人，不仅仅不贡献任何开源价值，
而且还持续索取开源界的技术，比如其他的开源端如TC端，AC，Cmangos,Vmangos端等等。
这些私服运营者架设的端在国内的游戏界的运营方式非常让人反感，运作得乌烟瘴气。
一开始以公益休闲服为目的进行宣传，然后慢慢逐步收割玩家。
架设的服务器里面各种商业收费玩法，游戏体验极差。

正如everwar长期以来坚持的事情，要做一个真正的游戏，游戏的本质是要获得良好的体验。

显然这些架设盈利私服的运营者和他们的技术支持者，选择了一个不合适不恰当的商业模式去运作。
这是everwar作者和支持者坚决反对的事情。

这些运营者长期在吸取并消耗开源界面的资源，以此盈利，却几乎不提供任何价值。
这些运营私服的人相当一部分不懂技术，甚至也不会玩游戏。他们通过找一些初级的技术人士来协助架设服务器。
他们的玩法就是买流量推广他们找的初级技术人士给他们架设的私服。

everwar项目曾经发布过一些可用版本和分支。后来发现那些所谓的关注者爱好者，
其实大部分都是白嫖党，他们自己的git号空空如也。

经过考虑，本项目将不再发布公开的版本和分支。但源代码依然开源和更新。未来的重点是开放闭源的魔兽世界项目。

目前已经上线，见官网 everwar.cn 
该版本彻底闭源，将整合everwar多年来的游戏开发实践，持续开发下去。同时不公开发布版本。
但是将开放服务器，用户、玩家、学习者、技术人士都可以
通过everwar.cn官网注册账号进行体验和游戏，也欢迎各位协助在游戏里面测试。
这个everwar服务器将完全免费，我们的宗旨是要做真正的公益休闲服务器，
而不是打着公益休闲的旗号不断搜刮钱财的私服。
